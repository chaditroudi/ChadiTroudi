...
import {
  ...
  Play, Calendar, MapPin, Globe, MessageCircle
} from "lucide-react";
...
const modules = [
  { title: "Java Fundamentals", desc: "OOP, Collections, Generics, Streams, Lambda expressions", weeks: "Weeks 1-3", icon: Coffee, color: "from-orange-500/20 to-amber-500/20" },
  { title: "Spring Boot & REST APIs", desc: "Build production-ready microservices & API design", weeks: "Weeks 4-6", icon: Rocket, color: "from-green-500/20 to-emerald-500/20" },
  { title: "Databases & JPA", desc: "PostgreSQL, Hibernate, query optimization, migrations", weeks: "Weeks 7-8", icon: Terminal, color: "from-blue-500/20 to-cyan-500/20" },
  { title: "Testing & CI/CD", desc: "JUnit 5, Mockito, Docker, GitHub Actions pipelines", weeks: "Weeks 9-10", icon: CheckCircle2, color: "from-purple-500/20 to-violet-500/20" },
  { title: "Cloud & Deployment", desc: "AWS, Kubernetes basics, monitoring & logging", weeks: "Weeks 11-12", icon: Globe, color: "from-pink-500/20 to-rose-500/20" },
  { title: "Final Project", desc: "Build & deploy a full-stack production application", weeks: "Weeks 13-14", icon: Trophy, color: "from-yellow-500/20 to-amber-500/20" },
];

const benefits = [
  { icon: Code2, text: "Hands-on coding every session", detail: "80% practice, 20% theory" },
  { icon: Users, text: "Small groups (max 8)", detail: "Personal attention guaranteed" },
  { icon: Clock, text: "Flexible schedule", detail: "Evening & weekend slots" },
  { icon: BookOpen, text: "Project portfolio", detail: "3+ production-ready apps" },
  { icon: Rocket, text: "Career support", detail: "CV review & mock interviews" },
  { icon: CheckCircle2, text: "Certificate", detail: "Industry-recognized credential" },
];

const testimonialStudents = [
  { name: "Sarah M.", text: "Went from zero coding to landing a junior dev role in 4 months!", avatar: "SM" },
...
const faqs = [
  { q: "Do I need prior programming experience?", a: "No! Our beginner track starts from absolute zero. We also have an accelerated track for those with some coding background." },
  { q: "What's the time commitment?", a: "Expect 10-15 hours/week: 4 hours of live sessions + 6-11 hours of practice and projects." },
  { q: "Is the certificate recognized?", a: "Yes, our certificate is recognized by our hiring partners across Germany and Europe." },
  { q: "What happens after the bootcamp?", a: "You'll join our alumni network, get 3 months of career support, and access to our job board with partner companies." },
];
  ...
  >
    <div className="bg-foreground/5 backdrop-blur-xl border border-border/30 rounded-xl p-4 font-mono text-xs shadow-2xl rotate-3 hover:rotate-0 transition-transform duration-500">
      ...
      <div className="space-y-1 text-muted-foreground">
        ...
        <div className="pl-4"><span className="text-purple-400">private</span> List{"<"}Skill{">"} skills;</div>
          ...
          <div className="text-center mb-8">
            ...
            <h2 className="text-4xl md:text-6xl font-bold font-display text-foreground mb-5 leading-tight">
              ...
              <span className="relative mx-3">
                <span className="text-gradient">Java Developer</span>
                <motion.svg
            ...
            <p className="text-muted-foreground text-lg md:text-xl max-w-2xl mx-auto mb-3">
              Intensive bootcamp with real-world projects, 1-on-1 mentorship, and career support.
            ...
            <div className="flex items-center justify-center gap-6 text-sm text-muted-foreground">
              ...
              <span className="flex items-center gap-1.5"><Calendar className="w-4 h-4" /> Evenings & Weekends</span>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start mb-20">
          ...
          <AnimatedSection direction="left" delay={0.2}>
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-2xl font-bold font-display text-foreground">Curriculum</h3>
            </div>
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                          <span className="text-xs text-muted-foreground bg-background/60 px-2 py-0.5 rounded-full">{mod.weeks}</span>
                        ...
                        {expandedModule === i && (
                          ...
                          >
                            <div className="mt-3 pt-3 border-t border-border/30 flex items-center gap-4 text-xs text-muted-foreground">
                              <span className="flex items-center gap-1"><Clock className="w-3 h-3" /> 12 hours</span>
                              <span className="flex items-center gap-1"><Code2 className="w-3 h-3" /> 4 projects</span>
                              <span className="flex items-center gap-1"><Play className="w-3 h-3" /> 8 lessons</span>
                            </div>
                          </motion.div>
                        )}
                      </AnimatePresence>
            ...
            <div className="relative">
              ...
              <div className="glass rounded-3xl p-8 border border-border/50 shadow-2xl">
                ...
                >
                  ...
                  <span>Only <strong>{spotsLeft} spots</strong> remaining for April cohort!</span>
                </motion.div>
                ...
                {submitted ? (
                  ...
                  >
                    ...
                    <h4 className="text-2xl font-bold text-foreground mb-2">You're In! 🎉</h4>
                    <p className="text-muted-foreground mb-4">Check <strong>{form.email}</strong> for details.</p>
                    <div className="flex flex-col gap-2 text-sm text-muted-foreground">
                      <span>✅ Confirmation email sent</span>
                      <span>📅 Pre-course materials coming soon</span>
                      <span>💬 Slack community invite on the way</span>
                    </div>
                  </motion.div>
                ) : (
                  <>
                    ...
                    <form onSubmit={handleSubmit}>
                      <AnimatePresence mode="wait">
                        {formStep === 1 && (
                          ...
                          >
                            ...
                            <Button
                              type="button"
                              className="w-full h-12 rounded-xl group text-base"
                              disabled={!canProceed}
                          ...
                          >
                            ...
                            <div>
                              ...
                              <textarea
                                ...
                                placeholder="I want to switch careers, build my own startup..."
                                maxLength={500}
                                rows={3}
                                className="mt-1.5 flex w-full rounded-xl border border-input bg-background px-4 py-3 text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring resize-none"
                              />
                            </div>
                            <div className="flex gap-3">
                              ...
                              <Button
                                type="submit"
                                className="flex-1 h-12 rounded-xl group text-base"
                      ...
                      <p className="text-xs text-muted-foreground text-center mt-4">
                        🔒 Free to register • No payment required • Cancel anytime
                      </p>
                    </form>
                  </>
                )}
