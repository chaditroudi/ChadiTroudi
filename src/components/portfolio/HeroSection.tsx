    ...
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-3xl">
          <p
            className="text-primary font-mono text-sm mb-4 opacity-0 animate-fade-in-up"
          ...
          <h2
            className="text-3xl md:text-5xl font-bold text-muted-foreground mb-6 opacity-0 animate-fade-in-up"
            style={{ animationDelay: "0.3s" }}
          >
            I build things for the web.
          </h2>
          <p
            className="text-muted-foreground max-w-xl text-lg leading-relaxed mb-10 opacity-0 animate-fade-in-up"
            style={{ animationDelay: "0.4s" }}
          >
            Full-stack engineer specializing in building exceptional digital
            experiences with React, Node.js, and modern cloud infrastructure.
            Currently focused on building accessible, performant web applications.
          </p>
          ...
          >
            ...
            <div className="flex items-center gap-4">
              ...
              <SocialLink href="mailto:alex@example.com" icon={<Mail size={20} />} label="Email" />
            </div>
          </div>
        </div>
      </div>
