...
const experiences = [
  ...
  },
  {
    ...
    bullets: [
      "Developed front-end modules using ReactJS and backend with Java EE & Spring Boot",
      "Integrated ERP solutions with Odoo and built custom features",
  ...
  },
  {
    ...
    bullets: [
      "Engineered robust backend services using Java Spring Boot",
      "Created RESTful APIs for car rental platform and banking dashboards",
